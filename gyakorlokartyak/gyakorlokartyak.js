...
{
let szam=Math.random()*legnagyobbSzam;
szam=Math.round(szam)
return szam;
}
function randomkartyagenerator(legnagyobbkartya=4){
    let kartya=Math.random()*legnagyobbkartya;
    kartya=Math.round(kartya)
    return kartya;
    }

let randomszam0=randomszamgenerator();
let randomszam1=randomszamgenerator();
let randomszam2=randomszamgenerator();
let randomszam3=randomszamgenerator();
let randomszam4=randomszamgenerator();
...
console.log(randomszam0)
console.log(randomszam1)
console.log(randomszam2)
console.log(randomszam3)
console.log(randomszam4)
...
const tippk=document.getElementById('tippk');
...
const magyarszoveg4tipp=document.getElementById('magyarszoveg4').textContent;
    ...
    if(tipp===magyarszoveg1tipp&&kartya1forditva==false){  pontok++;
        document.getElementById('pontok').innerHTML=pontok;
        document.getElementById('tipp').value="";
        card1.classList.toggle("forditas");
    ...
    if(tipp===magyarszoveg2tipp&&kartya2forditva==false){  pontok++;
        document.getElementById('pontok').innerHTML=pontok;
        document.getElementById('tipp').value="";
        card2.classList.toggle("forditas");
    ...
    if(tipp===magyarszoveg3tipp&&kartya3forditva==false){  pontok++;
        document.getElementById('pontok').innerHTML=pontok;
        document.getElementById('tipp').value="";
        card3.classList.toggle("forditas");
    ...
    if(tipp===magyarszoveg4tipp&&kartya4forditva==false){  pontok++;
        document.getElementById('pontok').innerHTML=pontok;
        document.getElementById('tipp').value="";
        card4.classList.toggle("forditas");
